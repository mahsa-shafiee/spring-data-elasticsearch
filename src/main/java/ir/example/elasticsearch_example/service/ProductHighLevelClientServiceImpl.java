...
@Slf4j
public class ProductHighLevelClientServiceImpl implements ProductHighLevelClientService {
    ...
    @Override
    public List<Product> toProductList(SearchHit[] searchHits) throws Exception {
